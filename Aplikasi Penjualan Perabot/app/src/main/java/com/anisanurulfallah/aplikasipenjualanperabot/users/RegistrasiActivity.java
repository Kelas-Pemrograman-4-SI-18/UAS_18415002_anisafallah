...
public class RegistrasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistrasi = (NoboButton) findViewById(R.id.btnRegis);
        ...
        btnRegistrasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (strUserName.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Email lengkap Tidak Boleh Kosong", Toast.LENGTH_LONG).show();
                } else if (strNotelepon.isEmpty()) {
                    Toast.makeText(getApplicationContext(), "No Telepon lengkap Tidak Boleh Kosong", Toast.LENGTH_LONG).show();
